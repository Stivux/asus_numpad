...
int start_numpad() {
  ...
  int return_value = numpad.DisableBackLight();
...
static std::unordered_map<std::string, int (*)()> start_funcs = {
#ifdef INCLUDE_UP5401EA
    {"up5401ea", start_numpad<asus_numpad::params::ParamsUP5401EA>},
#endif

#ifdef INCLUDE_B7402
    {"b7402", start_numpad<asus_numpad::params::ParamsB7402_I2C>},
#endif
};
